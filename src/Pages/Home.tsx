...
const announcements = [
  { date: "Mar 10", text: "2nd Semester enrollment opens March 15." },
  { date: "Mar 8",  text: "No classes on March 12 — Foundation Day." },
  { date: "Mar 5",  text: "Midterm exams scheduled March 18–22." },
];
          ...
          {services.map((s) => (
            <div className="col-sm-6 col-lg-3" key={s.title}>
              <div className="card h-100 shadow-sm border-0">
                <img src={s.img} alt={s.title} className="card-img-top" style={{ height: 160, objectFit: "cover" }} />
          ...
          <div className="col-lg-7">
            {announcements.map((a) => (
              <div className="d-flex gap-3 align-items-start bg-white bg-opacity-10 rounded-3 p-3 mb-3" key={a.text}>
                ...
                <p className="text-white mb-0 small">{a.text}</p>
              </div>
            ))}
          </div>
        </div>
